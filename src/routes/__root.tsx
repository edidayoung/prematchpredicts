...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PrematchPredict" },
      { name: "description", content: "AI-Powered Sports Betting Predictions" },
      { property: "og:title", content: "PrematchPredict" },
      { property: "og:description", content: "AI-Powered Sports Betting Predictions" },
